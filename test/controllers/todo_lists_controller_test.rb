...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { due_date: @todo_list.due_date, task_content: @todo_list.task_content, task_name: @todo_list.task_name, user_id: @todo_list.user_id } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { due_date: @todo_list.due_date, task_content: @todo_list.task_content, task_name: @todo_list.task_name, user_id: @todo_list.user_id } }
